...
final class Version20191212112440 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE timelapse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, resolution VARCHAR(255) COLLATE BINARY, schedule DATETIME , path VARCHAR(255) )');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE timelapse');
        $this->addSql('CREATE TABLE timelapse (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, resolution VARCHAR(255) , schedule DATETIME , destination VARCHAR(255) COLLATE BINARY)');
